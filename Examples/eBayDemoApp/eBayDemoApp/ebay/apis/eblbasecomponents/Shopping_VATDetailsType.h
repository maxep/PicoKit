...
*/
@property (nonatomic, strong) NSNumber *businessSeller;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *restrictedToBusiness;
...
*/
@property (nonatomic, strong) NSNumber *vatPercent;
...
*/
@property (nonatomic, strong) NSString *vatSite;
