...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *alternativeSearches;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *relatedSearches;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *categoryParentName;
