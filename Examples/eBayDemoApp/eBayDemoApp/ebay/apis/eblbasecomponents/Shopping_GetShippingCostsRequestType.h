...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *destinationPostalCode;
...
*/
@property (nonatomic, strong) NSString *destinationCountryCode;
...
*/
@property (nonatomic, strong) NSNumber *includeDetails;
