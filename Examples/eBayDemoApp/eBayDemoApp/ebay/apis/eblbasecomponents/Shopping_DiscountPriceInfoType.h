...
*/
@property (nonatomic, strong) Shopping_AmountType *originalRetailPrice;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *minimumAdvertisedPrice;
...
*/
@property (nonatomic, strong) NSString *minimumAdvertisedPriceExposure;
...
*/
@property (nonatomic, strong) NSString *pricingTreatment;
...
*/
@property (nonatomic, strong) NSNumber *soldOneBay;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *soldOffeBay;
