...
@property (nonatomic, strong) NSMutableArray *internationalShippingServiceOption;
...
*/
@property (nonatomic, strong) Shopping_SalesTaxType *salesTax;
...
*/
@property (nonatomic, strong) NSString *shippingRateErrorMessage;
...
@property (nonatomic, strong) NSMutableArray *shippingServiceOption;
...
*/
@property (nonatomic, strong) Shopping_TaxTableType *taxTable;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *internationalInsuranceCost;
...
/**
 ...
 type: string constant in Shopping_InsuranceOptionCodeType.h
*/
@property (nonatomic, strong) NSString *internationalInsuranceOption;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *codCost;
