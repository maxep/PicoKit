...
*/
@property (nonatomic, strong) NSNumber *feedbackPrivate;
...
*/
@property (nonatomic, strong) NSString *feedbackRatingStar;
...
*/
@property (nonatomic, strong) NSNumber *feedbackScore;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *userAnonymized;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *ebayNewUser;
...
*/
@property (nonatomic, strong) NSString *registrationSite;
...
*/
@property (nonatomic, strong) NSString *sellerBusinessType;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *sellerItemsURL;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *myWorldURL;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *myWorldSmallImage;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *myWorldLargeImage;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *reviewsAndGuidesURL;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *feedbackDetailsURL;
...
*/
@property (nonatomic, strong) NSNumber *positiveFeedbackPercent;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *topRatedSeller;
