...
*/
@property (nonatomic, strong) NSString *commentingUser;
...
*/
@property (nonatomic, strong) NSNumber *commentingUserScore;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *feedbackResponse;
...
*/
@property (nonatomic, strong) Shopping_AmountType *itemPrice;
...
*/
@property (nonatomic, strong) NSNumber *commentReplaced;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *responseReplaced;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *followUpReplaced;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *countable;
