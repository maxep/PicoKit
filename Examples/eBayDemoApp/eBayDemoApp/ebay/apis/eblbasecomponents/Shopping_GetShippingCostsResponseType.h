...
*/
@property (nonatomic, strong) Shopping_ShippingDetailsType *shippingDetails;
...
*/
@property (nonatomic, strong) Shopping_PickUpInStoreDetailsType *pickUpInStoreDetails;
