...
@property (nonatomic, strong) NSMutableArray *bidRetractionFeedbackPeriods;
...
@property (nonatomic, strong) NSMutableArray *negativeFeedbackPeriods;
...
@property (nonatomic, strong) NSMutableArray *neutralFeedbackPeriods;
...
@property (nonatomic, strong) NSMutableArray *positiveFeedbackPeriods;
...
@property (nonatomic, strong) NSMutableArray *totalFeedbackPeriods;
...
*/
@property (nonatomic, strong) NSNumber *uniqueNegativeFeedbackCount;
...
/**
 ...
 type : NSNumber, wrapper for primitive long
*/
@property (nonatomic, strong) NSNumber *uniquePositiveFeedbackCount;
...
@property (nonatomic, strong) NSMutableArray *averageRatingDetails;
...
/**
 ...
 type : NSNumber, wrapper for primitive long
*/
@property (nonatomic, strong) NSNumber *neutralCommentCountFromSuspendedUsers;
...
/**
 ...
 type : NSNumber, wrapper for primitive long
*/
@property (nonatomic, strong) NSNumber *uniqueNeutralFeedbackCount;
