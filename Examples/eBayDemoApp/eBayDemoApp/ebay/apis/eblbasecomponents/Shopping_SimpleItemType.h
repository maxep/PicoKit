...
*/
@property (nonatomic, strong) NSNumber *bestOfferEnabled;
...
*/
@property (nonatomic, strong) Shopping_AmountType *buyItNowPrice;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *buyItNowAvailable;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *convertedBuyItNowPrice;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *viewItemURLForNaturalSearch;
...
*/
@property (nonatomic, strong) Shopping_SimpleUserType *seller;
...
/**
 ...
 type : class Shopping_SimpleUserType
*/
@property (nonatomic, strong) Shopping_SimpleUserType *highBidder;
...
*/
@property (nonatomic, strong) NSString *listingStatus;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *reserveMet;
...
@property (nonatomic, strong) NSMutableArray *shipToLocations;
...
*/
@property (nonatomic, strong) Shopping_ShippingCostSummaryType *shippingCostSummary;
...
*/
@property (nonatomic, strong) Shopping_NameValueListArrayType *itemSpecifics;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *primaryCategoryIDPath;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *secondaryCategoryID;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *secondaryCategoryIDPath;
...
*/
@property (nonatomic, strong) Shopping_CharityType *charity;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *germanMotorsSearchable;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *getItFast;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *pictureExists;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *recentListing;
...
*/
@property (nonatomic, strong) Shopping_StorefrontType *storefront;
...
*/
@property (nonatomic, strong) Shopping_DistanceType *distanceFromBuyer;
...
*/
@property (nonatomic, strong) NSString *halfItemCondition;
...
*/
@property (nonatomic, strong) Shopping_ReturnPolicyType *returnPolicy;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *minimumToBid;
...
*/
@property (nonatomic, strong) Shopping_ProductIDType *productID;
...
*/
@property (nonatomic, strong) Shopping_BusinessSellerDetailsType *businessSellerDetails;
...
@property (nonatomic, strong) NSMutableArray *paymentAllowedSite;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *integratedMerchantCreditCardEnabled;
...
*/
@property (nonatomic, strong) Shopping_VariationsType *variations;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *conditionID;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *conditionDisplayName;
...
*/
@property (nonatomic, strong) NSString *quantityAvailableHint;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *quantityThreshold;
...
@property (nonatomic, strong) NSMutableArray *excludeShipToLocation;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *vhrUrl;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *vhrAvailable;
...
*/
@property (nonatomic, strong) Shopping_QuantityInfo *quantityInfo;
...
*/
@property (nonatomic, strong) Shopping_UnitInfoType *unitInfo;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *globalShipping;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *itemCompatibilityCount;
...
*/
@property (nonatomic, strong) Shopping_ItemCompatibilityListType *itemCompatibilityList;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *ebayNewBestOffer;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *eBayNowEligible;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *eBayNowAvailable;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *ignoreQuantity;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *availableForPickupDropOff;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *eligibleForPickupDropOff;
