...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *buyingGuideCount;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *reviewerRank;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *totalHelpfulnessVotes;
...
*/
@property (nonatomic, strong) Shopping_BuyingGuideDetailsType *buyingGuideDetails;
...
*/
@property (nonatomic, strong) Shopping_ReviewDetailsType *reviewDetails;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *positiveHelpfulnessVotes;
