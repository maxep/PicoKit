...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *stockPhotoURL;
...
*/
@property (nonatomic, strong) NSNumber *displayStockPhotos;
...
*/
@property (nonatomic, strong) Shopping_SimpleItemArrayType *itemArray;
...
*/
@property (nonatomic, strong) Shopping_AmountType *minPrice;
