...
@property (nonatomic, strong) NSMutableArray *queryKeywords;
...
*/
@property (nonatomic, strong) NSNumber *maxKeywords;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *maxResultsPerPage;
...
*/
@property (nonatomic, strong) NSNumber *includeChildCategories;
