...
*/
@property (nonatomic, strong) Shopping_CategoryArrayType *categoryArray;
...
*/
@property (nonatomic, strong) NSNumber *categoryCount;
...
*/
@property (nonatomic, strong) NSString *categoryVersion;
