...
*/
@property (nonatomic, strong) Shopping_SimpleUserType *user;
...
*/
@property (nonatomic, strong) Shopping_FeedbackHistoryType *feedbackHistory;
...
@property (nonatomic, strong) NSMutableArray *feedbackDetails;
