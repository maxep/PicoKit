...
*/
@property (nonatomic, strong) NSNumber *userDisplayHint;
...
*/
@property (nonatomic, strong) NSString *severityCode;
...
@property (nonatomic, strong) NSMutableArray *errorParameters;
...
*/
@property (nonatomic, strong) NSString *errorClassification;
