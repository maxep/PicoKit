...
@private
    ...
    NSDate *_shippingServiceCutOffTime;
    NSMutableArray *_any;
...
*/
@property (nonatomic, strong) Shopping_AmountType *shippingInsuranceCost;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *shippingServiceAdditionalCost;
...
*/
@property (nonatomic, strong) NSNumber *shippingServicePriority;
...
*/
@property (nonatomic, strong) NSNumber *expeditedService;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *shippingTimeMin;
...
/**
 ...
 type : NSNumber, wrapper for primitive int
*/
@property (nonatomic, strong) NSNumber *shippingTimeMax;
...
/**
 ...
 type : class Shopping_AmountType
*/
@property (nonatomic, strong) Shopping_AmountType *shippingSurcharge;
...
@property (nonatomic, strong) NSMutableArray *shipsTo;
...
*/
@property (nonatomic, strong) NSDate *estimatedDeliveryMinTime;
...
/**
 ...
 type : NSDate, wrapper for primitive date
*/
@property (nonatomic, strong) NSDate *estimatedDeliveryMaxTime;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *fastAndFree;
...
/**
 ...
 <pre>
 &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;br xmlns="urn:ebay:apis:eBLBaseComponents" xmlns:ns="urn:ebay:apis:eBLBaseComponents" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:wsdlsoap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xs="http://www.w3.org/2001/XMLSchema"/&gt;
 </pre>
 ...
 type : NSDate, wrapper for primitive date
*/
@property (nonatomic, strong) NSDate *shippingServiceCutOffTime;
