...
*/
@property (nonatomic, strong) NSNumber *availableItemsOnly;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, strong) NSString *queryKeywords;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *hideDuplicateItems;
