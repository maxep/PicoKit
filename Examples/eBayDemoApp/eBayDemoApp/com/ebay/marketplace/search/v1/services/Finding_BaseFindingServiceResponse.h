...
*/
@property (nonatomic, strong) Finding_SearchResult *searchResult;
...
*/
@property (nonatomic, strong) Finding_PaginationOutput *paginationOutput;
...
*/
@property (nonatomic, strong) NSString *itemSearchURL;
