...
*/
@property (nonatomic, strong) Finding_Amount *shippingServiceCost;
...
*/
@property (nonatomic, strong) NSNumber *expeditedShipping;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *oneDayShippingAvailable;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, strong) NSNumber *intermediatedShipping;
