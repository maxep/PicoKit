...
/**
 ...
 listings, currentPriceis the current fixed price.
 <br><br>
...
*/
@property (nonatomic, strong) Finding_Amount *buyItNowPrice;
...
/**
 ...
 type : class Finding_Amount
*/
@property (nonatomic, strong) Finding_Amount *convertedBuyItNowPrice;
