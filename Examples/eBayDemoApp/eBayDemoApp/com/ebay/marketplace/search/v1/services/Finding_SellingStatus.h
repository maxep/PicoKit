...
*/
@property (nonatomic, strong) Finding_Amount *currentPrice;
...
/**
 ...
 type : class Finding_Amount
*/
@property (nonatomic, strong) Finding_Amount *convertedCurrentPrice;
...
*/
@property (nonatomic, strong) NSString *sellingState;
