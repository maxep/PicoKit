...
-(void)addToCart {
    ...
    // create request
    CartCreate *request = [[CartCreate alloc] init];
    request.associateTag = @"tag";
    
    CartCreateRequest *cartCreateRequest = [[CartCreateRequest alloc] init];
    cartCreateRequest.items = [[CartCreateItems alloc] init];
    cartCreateRequest.items.item = [NSMutableArray array];
    CartCreateItem *cartCreateItem = [[CartCreateItem alloc] init];
